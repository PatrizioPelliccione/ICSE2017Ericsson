...
Randomized delays detect misconfigured timeout handling. This was not identified by manual testing since the testers made the same wrong assumptions of the developers, %produced code, %manual test case had the same mistake of the production code, 
